...
static const HexReplace hex_replacements[] = {
    ...
    /* Neutral dark blues → true neutrals */
    {"#303036", "#303030"}, {"#222226", "#242424"}, {"#3c3c44", "#383838"},
    {"#44444c", "#383838"}, {"#38383e", "#383838"}, {"#494951", "#484848"},
    {"#29292e", "#2a2a2a"}, {"#5e5e69", "#585858"}, {"#333339", "#333333"},
    {"#202023", "#1e1e1e"}, {"#2e2e33", "#2a2a2a"}, {"#2c2c31", "#2a2a2a"},
    {"#18181b", "#1a1a1a"}, {"#313136", "#303030"},
    /* Remaining Mint-Y blueish darks → Adwaita neutrals */
    {"#161619", "#161616"}, {"#1b1b1e", "#1b1b1b"}, {"#1d1d21", "#1d1d1d"},
    {"#242429", "#242424"}, {"#26262a", "#262626"}, {"#27272b", "#272727"},
    {"#27272c", "#272727"}, {"#2a2a2f", "#2a2a2a"}, {"#313137", "#313131"},
    {"#39393f", "#393939"}, {"#3a3a41", "#3a3a3a"}, {"#46464e", "#464646"},
    {"#4c4c50", "#4c4c4c"}, {"#555559", "#555555"}, {"#55555f", "#555555"},
    {"#333338", "#333333"},
    {NULL, NULL}
};
...
static const RgbaReplace rgba_replacements[] = {
    ...
    {"rgba(48, 48, 54",    "rgba(48, 48, 48"},
    {"rgba(34, 34, 38",    "rgba(36, 36, 36"},
    {"rgba(29, 29, 33",    "rgba(30, 30, 30"},
    {NULL, NULL}
};
